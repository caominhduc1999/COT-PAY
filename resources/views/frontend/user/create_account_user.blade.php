    ...
    <div class="row mt-5">
        ...
        <div class="content-info col-md-6">
            ...
            <form method="post">
                ...
                <input class="form-control" type="text" name="name_user" placeholder="Tên shop" value="{{old('name_shop')}}">
                ...
                <select class="form-control js-location" data-type="city" name="city">
                    ...
                    <option @if(old('city')==$city->code) selected @endif value="{{$city->code}}">{{$city->name}}
                    </option>
                    @endforeach
                </select>
                ...
                <div class="agree-create-account">
                    <a title><button style="background: none; border: none; color: #ffffff" type="submit">Đồng ý và tạo
                            tài khoản</button></a>
                </div>
            </form>
        </div>
