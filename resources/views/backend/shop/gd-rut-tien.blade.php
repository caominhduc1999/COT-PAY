					...
					<div class="panel-body">
						<div class="main-menu choose-wallet">
							...
							<div class="col-md-6 col-sm-6">
								<div class="deposits-withdrawals withdrawals">
									<div class="title-text withdrawals">
										<h1 style="color: white;margin: 10px 0px;">Số tiền cần rút</h1>
									</div>
									<div class="amount-of-money">
										<p>5.200.000</p>
									</div>
								</div>
								<div class="title-text withdrawals" style="background: #40B649;">
									<h1 style="color: white;margin: 10px 0px;">Hình thức chuyển tiền</h1>
								</div>
								<div class="option withdrawals">
								...
								<div class="connect  withdrawals">
									<a href="#" title class="submit" style="width: 100%;display: block;">Rút
										tiền</a>
								</div>
							</div>
							<div class="col-md-3 col-sm-3"></div>
